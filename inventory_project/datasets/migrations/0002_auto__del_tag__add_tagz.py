...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tagz'
        db.create_table(u'datasets_tagz', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'datasets', ['Tagz'])

        # Removing M2M table for field tags on 'Dataset'
        db.delete_table(db.shorten_name(u'datasets_dataset_tags'))

        # Adding M2M table for field tagz on 'Dataset'
        m2m_table_name = db.shorten_name(u'datasets_dataset_tagz')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dataset', models.ForeignKey(orm[u'datasets.dataset'], null=False)),
            ('tagz', models.ForeignKey(orm[u'datasets.tagz'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dataset_id', 'tagz_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Tagz'
        db.delete_table(u'datasets_tagz')
        ...
        # Removing M2M table for field tagz on 'Dataset'
        db.delete_table(db.shorten_name(u'datasets_dataset_tagz'))
    ...
    models = {
        ...
        u'datasets.dataset': {
            ...
            'tagz': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['datasets.Tagz']", 'null': 'True', 'blank': 'True'}),
