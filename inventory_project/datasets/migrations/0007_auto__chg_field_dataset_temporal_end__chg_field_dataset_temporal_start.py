...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dataset.temporal_end'
        db.alter_column(u'datasets_dataset', 'temporal_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Dataset.temporal_start'
        db.alter_column(u'datasets_dataset', 'temporal_start', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Dataset.temporal_end'
        db.alter_column(u'datasets_dataset', 'temporal_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Dataset.temporal_start'
        db.alter_column(u'datasets_dataset', 'temporal_start', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'datasets.dataset': {
            ...
            'temporal_end': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'temporal_start': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
